...
<table class="quotation">
    <tbody>
        <?php if($language == "english"){ ?>
            <tr><td colspan="4" style="text-align:center;background: #ddd;padding: 10px;font-size: 16px;font-weight: bold;">PURCHASE</td></tr>
            <tr>
                <td width="15%" style="text-align: right;font-weight: bold;">Supplier : </td>
                <td width="45%"><?php echo $purchase_order['vSupplierName']; ?></td>
                <td width="20%" style="text-align: right;font-weight: bold;">Purchase No :</td>
                <td width="20%"><?php echo $purchase_order['vPurchaseOrderNo']; ?></td>
            </tr>
            <tr>
                <td style="text-align: right;font-weight: bold;">Address  : </td>
                <td><?php echo $purchase_order['vAddress'] ?></td>
                <td style="text-align: right;font-weight: bold;">Purchase Date :</td>
                <td><?php echo date("d-m-Y",strtotime($purchase_order['dDeliveryDate'])); ?></td>
            </tr>
            <tr>
                <td style="text-align: right;font-weight: bold;">Phone No : </td>
                <td><?php echo $purchase_order['vPhoneNumber'] ?></td>
        ...
        <?php }if($language == "tamil"){ ?>
            ...
            <tr>
                <td width="22%" style="text-align: right;font-weight: bold;">வாடிக்கையாளர் : </td>
                <td width="28%"><?php echo $purchase_order['vSupplierName_Tamil']; ?></td>
                <td width="30%" style="text-align: right;font-weight: bold;">விலைப்பட்டியல் எண் :</td>
                <td width="20%"><?php echo $purchase_order['vPurchaseOrderNo']; ?></td>
            </tr>
            <tr>
            ...
            <?php } if(!empty($purchase_order['gst_no'])){ ?>
            <tr>
                <td style="text-align: right;font-weight: bold;">GSTIN : </td>
                <td><?php echo $purchase_order['gst_no']; ?></td>
...
<table class="product-list" id="product-list" cellpadding ="0" cellspacing="0">
    <thead>
        <?php if($language == "english"){ ?>
            <tr>
                ...
                <th width="15%">Qty</th>
                <th width="10%">Rate</th>
                <?php if(!empty($purchase_order['CGST'] || $purchase_order['SGST'])){ ?>
                <th class="pp" width="10%">GST%</th>
               <?php } else {?>
                <th class="ss"  width="10%">IGST%</th>
                <?php } ?>
    ...
    <tbody>
        <?php $i=1; foreach($purchase_order['purchase_details'] as $key=>$order){ ?>
            <tr data-id="<?php echo $i; ?>">
                <td class="text-center"><?php echo $i; ?></td>
                <?php if($language == "english"){ ?>
                <td><?php echo $order['vProductName']; ?></td>
                <?php }if($language == "tamil"){ 
                    if(!empty($order['vProductName_Tamil'])){ ?>
                <td><?php echo $order['vProductName_Tamil']; ?></td>
                <?php }else{ ?> 
                    <td><?php echo $order['vProductName']; ?></td>
                <?php } } ?>
                <td class="text-center"><?php echo $order['vHSNNO']; ?></td>
                <td class="text-center quantity"><?php echo $order['iPurchaseQTY'] ?></td>
                <td class="text-right price"><?php echo $order['iPurchaseCostperQTY'] ?></td>
                <?php if($order['CGST']!=0 || $order['SGST']!=0){ ?>
                <td class="text-right cgst"> 5.00</td>
                <?php } else {?>
                    <td class="text-right igst"> 5.00</td>
                <?php }?>
                <td class="text-right net_value"><?php echo $order['iPurchaseCostperQTY'] ?></td>
            </tr>
        <?php $i++; } ?>
        </tbody>
    </table>
        ...
        <tbody>
            ...
            <tr>
                <?php if($language == "english"){ ?>
                    ...
                    <td>%</td>
                    <td>Amount</td> -->
                    <td class="text-right">Freight Amt :</td> 
                ...
                <?php if($language == "tamil"){ ?>
                    ...
                    <td>%</td>
                    <td>தொகை</td> -->
                    <td class="text-right">சரக்கு தொகை :</td>
                    <td class="text-right">-</td>
                <?php } ?>
            </tr>
            <tr>
                <?php if($language == "english"){ ?>
                    ...
                    <td>%</td>
                    <td>Amount</td> -->
                    <td class="text-right">Loading Charge :</td> 
                    <td class="text-right">-</td>
                <?php } ?>
                <?php if($language == "tamil"){ ?>
                    <!-- <td>%</td>
                    ...
                    <td>%</td>
                    <td>தொகை</td> -->
                    <td class="text-right">ஏற்றுதல் கட்டணம் :</td>
                    <td class="text-right">-</td>
                <?php } ?>
            </tr>
            <?php if($language == "english"){ ?>
            ...
            <?php } ?>
            <?php $j=1; foreach ($purchase_order['purchase_details'] as $key => $order_) { ?>
                <tr data-id="<?php echo $j; ?>" style="display:none">
                    ...
                    <td class="igst" width="5%" class="text-right"><?php echo $order_['IGST'] ?></td>
...
<table class="footer" cellpadding ="0" cellspacing="0">
    <tbody>
        <tr>
            <td width="60%" class="rupeesinwords"><b>Amount in Words : </b ></td>
            <?php if($language == "english"){ ?>
                <td width="25%" style="font-weight: bold;font-size: 20px;" class="text-right">Net Amt :</td>
                <td width="15%" style="font-weight: bold;font-size: 20px;" class="text-right final_amt"></td>
            <?php }if($language == "tamil"){ ?>
                <td width="25%" style="font-weight: bold;font-size: 20px;" class="text-right">நிகர தொகை :</td>
                <td width="15%" style="font-weight: bold;font-size: 20px;" class="text-right final_amt"></td>
            <?php } ?>
        </tr>
    </tbody>
...
<table class="footer-sign" cellpadding ="0" cellspacing="0">
    <tr>
        <?php if($language == "english"){ ?>
        <td width="50%">Customer Signature </td>
        <td width="50%" style="text-align: right;">For COOL IN COOL STORE <br><br><br><br><br><br>Authorised Signatory</td>
        <?php } ?>
        <?php if($language == "tamil"){ ?>
        <td width="50%">வாடிக்கையாளர் கையொப்பம் </td>
        <td width="50%" style="text-align: right;">கூல் இன் கூல் ஆர்கானிக் உணவுகள்<br><br><br><br><br><br>அங்கீகரிக்கப்பட்ட கையொப்பமிட்டவர்</td>
        <?php } ?>
    </tr>
</table><br>
        ...
        function calculate(dataID,quantity=''){
            ...
            $('.product-list').find('.price').each(function(){
                ...
                if (Number(quantity.text()) != 0) {
                    ...
                    tot = Number(quantity.text()) * Number(taxable_cost_qty).toFixed(2);
                    subtotal.text(tot.toFixed(2));
                    ...
                    // $('cgst_price').text(Number(cgst_price).toFixed(2));
                    // $('sgst_price').text(Number(sgst_price).toFixed(2));
                    // $('igst_price').text(Number(igst_price).toFixed(2));
            ...
            if(total_cgst_price!=0 || total_sgst_price){
            ...
            $('.total_cgst').text(total_cgst_price.toFixed(2));
            $('.total_sgst').text(total_sgst_price.toFixed(2));
            // $('.total_igst').text(total_igst_price.toFixed(2));
