...
class Pharmacy_billing extends MY_Controller {
   ...
   public function __construct(){
    ...
    public function get_suppliers(){
        ...
        $list=$this->pharmacy_billing_model->supplier_list();
        ...
        $output = array(    
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->pharmacy_billing_model->count_all_suppliers(),
            "recordsFiltered" => $this->pharmacy_billing_model->count_all_suppliers(),
            "data" => $data,
        );
