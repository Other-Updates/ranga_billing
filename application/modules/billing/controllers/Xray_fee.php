...
class Xray_fee extends MY_Controller {
   ...
   public function __construct(){
       if(empty($this->session->userdata('LoggedId'))){
	    ...
	    parent::__construct();
        $this->load->model('xray_fee_model'); 
    ...
    public function add_xray_fee(){
        ...
        $this->template->write_view('content', 'add_xray_fees', $data);
        $this->template->render();
    }

    public function edit_xray_fee($id){
        ...
        $this->template->write_view('content', 'edit_xray_fees', $data);
        $this->template->render();
    }

    public function view_xray_fee($id){
        $data['sales_order_id'] = $id;
        ...
        $data['customer'] = $this->order_model->get_customer();
        $data['unit'] = $this->order_model->get_unit();
        $this->template->write_view('content', 'view_xray_fees', $data);
        $this->template->render();
    }
    ...
    public function edit_supplier(){
        ...
        $data = $this->xray_fee_model->supplier_by_id($supplier_id);
    ...
    public function update_supplier(){
        ...
        $this->xray_fee_model->update_supplier($id,$supplier);
