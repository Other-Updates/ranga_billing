...
class Consulting_fee extends MY_Controller {
   ...
   public function __construct(){
    ...
    public function get_consult_bills(){
        ...
        foreach ($list as $key=>$post) {
            ...
            $edit = '<a href="'.base_url('billing/consulting_fee/edit_consult_fee/').$post->iSalesOrderId.'" data-id="'.$post->iSalesOrderId.'" class="action-icon" ><i class="fa fa-pencil td-icon tm2"></i></a>';
            ...
            if($post->eDeliveryStatus == "Delivered"){
                $edit = "";
                $delete = "";
                $return = '<a href="'.base_url('billing/consulting_fee/consult_fee_return/').$post->iSalesOrderId.'" data-id="'.$post->iSalesOrderId.'" class="action-icon" ><button style="font-size: 11px;padding: 0px 8px;" class="btn btn-return">Return</button></a></a>';
    ...
    public function edit_supplier(){
        ...
        $data = $this->consulting_fee_model->supplier_by_id($supplier_id);
    ...
    public function update_supplier(){
        ...
        $this->consulting_fee_model->update_supplier($id,$supplier);
