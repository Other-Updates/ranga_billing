...
class Consulting_fee extends MY_Controller {
   ...
   public function __construct(){
    ...
    public function get_suppliers(){
        ...
        $list=$this->consulting_fee_model->supplier_list();
        ...
        $output = array(    
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->consulting_fee_model->count_all_suppliers(),
            "recordsFiltered" => $this->consulting_fee_model->count_all_suppliers(),
            "data" => $data,
        );
