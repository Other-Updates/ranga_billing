                    	...
                    	<?php
							...
							//	print_r($all_receipt);
								foreach($all_receipt as $val)
								{
									...
									{
									?>
                                    	<a href="<?php echo $this->config->item('base_url').'sales_receipt/update_receipt/'.$val['id']?>" data-toggle="tooltip" class="fa fa-pencil td-icon tooltips" title="" data-original-title="Edit">&nbsp;</a>
                                        <?php }?>
