...
<table style="padding: 2px 2px;" row-style="page-break-inside:avoid;">
    ...
    <tr>
        <td align="left" ><b>Name:</b>
            <b><?php echo ucfirst($receipt_details[0]['vCustomerName']); ?></b><br />
    ...
    <tr>
        <td align="left"><b>Invoice NO : </b><?php echo $receipt_details[0]['vSalesOrderNo'] ?></td>
...
<!--        <td width ="11%"><b>CGST&nbsp;%</b></td>
        ...
        <td width ="18%" align="right"><b>Net&nbsp;Value</b></td>
    </tr>
    <tbody>
        <?php
        $i = 1;
        if (isset($receipt_details[0]['po_details']) && !empty($receipt_details[0]['po_details'])) {
            foreach ($receipt_details[0]['po_details'] as $vals) {
                ...
                <tr>
                    ...
                    <td align="center">
                        <?php echo $vals['iDeliveryQTY'] ?>
                    </td>
                    <td align="right">
                        <?php echo number_format($vals['iDeliveryCostperQTY'], 2); ?>
                    </td>
                    <td align="center">
                        <?php echo $vals['discount'] ?>
                    </td>
                    <td align="right">
                        <?php echo number_format($vals['iDeliverySubTotal'], 2) ?>
                    </td>
                </tr>
                <?php
                $i++;
    ...
    <tfoot>
        <tr>
            ...
            <td align="center"><?php echo $receipt_details[0]['iDeliverySubTotal']; ?></td>
            <td colspan="2" align="right"><b>Sub Total</b></td>
            <td align="right"><?php echo number_format($receipt_details[0]['iDeliverySubTotal'], 2); ?></td>
        </tr>
        <tr>
...
<!--        <tr>
        ...
        <tr>
            <td colspan="5" align="right"><strong>Received Amount</strong></td>
            <td align="right"><?php echo number_format($receipt_details[0]['receipt_history'][0]['bill_amount'], 2, '.', ',') ?></td>
        </tr>
        <tr>
            <td colspan="5" align="right"><strong>Discount ( <?php echo $receipt_details[0]['receipt_history'][0]['discount_per'] ?> %)</strong></td>
            <td align="right"><?php echo number_format($receipt_details[0]['receipt_history'][0]['discount'], 2, '.', ',') ?> </td>
        </tr>
        <tr>
            <td colspan="5" align="right"><strong>Balance Amount</strong></td>
