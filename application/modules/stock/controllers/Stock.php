   ...
   public function __construct(){
    ...
    public function get_branch_stock(){
        ...
        foreach ($list as $key=>$post) {
            ...
            $delete = '<a href="" data-id="'.$post->iDeliveryOrderId.'" class="action-icon removeAttr " ><i class="fa fa-trash td-icon"></i></a>';
            $edit = '<a href="'.base_url('stock/edit_stock/'.$post->iDeliveryOrderId).'" data-id="'.$post->iDeliveryOrderId.'" class="action-icon addAttr"><i class="fa fa-pencil td-icon"></i></a>';
            }
            $view = "";
            $return = "";
            if($post->eDeliveryStatus == "Completed"){
                ...
                $edit = "";
                $delete = "";
                $return = '<a href="'.base_url('stock/delivery_order_return/').$post->iDeliveryOrderId.'" data-id="'.$post->iDeliveryOrderId.'" class="action-icon" ><button style="font-size: 11px;padding: 0px 8px;" class="btn btn-return">Return</button></a></a>';
