                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="card-footer text-end"> <div class="col-sm-12 col-lg-12 col-xl-12 submit"><input type="submit" class="btn btn-success"> <a href="<?php echo base_url('stock') ?>"><input class="btn btn-danger pull-left" type="button" value="Cancel"></a></div></div>
                        </div>                        
                    </div>
                </div>
            </div>        
