...
<form action=<?php echo base_url('stock/update_delivery_details'); ?> autocomplete="off" class="needs-validation" novalidate="" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3 select2-drpdwn">
                            ...
                            <div class="col-md-4">
                                ...
                                <textarea class="form-control add_ship_address" id="validationCustom03" type="text" name="shipping_adress" placeholder=""><?php echo $delivery_details[0]['vShippingAddress']; ?></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    <table class="table delivery-order basictable" id="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="4%" scope="col" class="text-center"><b class="wnone">Remove</b> <button type="button" class="btn btn-success btn-sm" id="add"><i class="icofont icofont-plus"></i></button></th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tr id="row" class="dynamic-added product_added_<?php echo $order['iCatagoryId'].'_'.$order['iProductId'].'_'.$order['iProductUnitId'].'_'.$order['iProductColorId']; ?>" dynamic_class="product_added_<?php echo $order['iCatagoryId'].'_'.$order['iProductId'].'_'.$order['iProductUnitId'].'_'.$order['iProductColorId']; ?>">
                                            ...
                                            <td scope="col">
                                                ...
                                                <div class="col-md-4 p-0-5"><span class="label label-success available_qty" ><?php echo $order['product_qty'] ?> </span></div>
                                            ...
                                            <td scope="col">
                                                <div class="">
                                                <input class="form-control cgst cgst_cls_<?php echo $key ?>" id="validationCustomUsername" name="cgst[]" type="text" placeholder="" aria-describedby="inputGroupPrepend"  required value="<?php echo $order['CGST'] ?>">
                                                <!-- <div class="invalid-feedback">Field is required.</div> -->
                                                </div>
                                            </td>
                                            <td scope="col">
                                                <div class="">
                                                <input class="form-control sgst sgst_cls_<?php echo $key ?>" id="validationCustomUsername" name="sgst[]" type="text" placeholder="" aria-describedby="inputGroupPrepend"  required value="<?php echo $order['SGST'] ?>">
                                                <!-- <div class="invalid-feedback">Field is required.</div> -->
                                                </div>
                                            </td>
                                            <td scope="col">
                                                <div class="">
                                                <input class="form-control igst igst_cls_<?php echo $key ?>" id="validationCustomUsername" name="igst[]" type="text" placeholder="" aria-describedby="inputGroupPrepend"  value="<?php echo $order['IGST'] ?>"  >
                                                <div class="invalid-feedback">Field is required.</div>
                                                </div>
                                            </td>
                                            <td scope="col">
                                            ...
                                            <td> <!--<button type="button" name="remove" id="'+i+'" data-id="<?php //echo $order['iDeliveryOrderDetailsId'] ?>" class="btn btn-danger btn_remove btn-sm"><i class="icofont icofont-minus"></i></button> --></td>
                                        </tr>
                                        <?php } ?>
                                        <tfoot>
                            ...
                            <div class="card-footer text-end"> <div class="col-sm-12 col-lg-12 col-xl-12"><input type="submit" class="btn btn-success submit"> <a href="<?php echo base_url('stock') ?>"><input class="btn btn-danger pull-left" type="button" value="Cancel"></a></div></div>
                        </div>                        
                    </div>
                </div>
            </div>        
...
<script type="text/javascript">
    ...
    {  
        ...
        $(document).on('click', '#add', function(e){  
            e.preventDefault();
           i++;  
           $('#table').append('<tr id="row'+i+'" class="dynamic-added"><td scope="col" data-th="Category"><div class="relative category_field'+i+'"><div class="invalid-feedback">Please select a valid state.</div></div></td><td scope="col" data-th="Product"><div class="relative"><input class="form-control product product_details_'+i+'" id="validationCustomUsername" name="product[]" type="text" placeholder="" aria-describedby="inputGroupPrepend" required ><input type="hidden" class="product_id_'+i+' product_id" name="product_id[]"><input type="hidden" class="product_color_id_'+i+' product_color_id" name="product_color_id[]" ><div class="search-list"><ul class="suggesstion-box" data-id="'+i+'"></ul></div></div></td><td scope="col" data-th="Unit"><div class="relative"><select class="form-select product_unit unit_'+i+'" name="unit[]" id="validationCustom04" required><option selected="" disabled="" value="">Choose...</option></select><span class="duplicate_value"></span><input type="hidden" class="duplicate_value_err"></div></td><td scope="col" data-th="Quantity"><div class="row quantity-row"><div class="col-md-7 wp-r-0"><input class="form-control quantity" id="validationCustomUsername" name="quantity[]" type="text" placeholder="" aria-describedby="inputGroupPrepend" required ></div><div class="col-md-4 p-0-5"><span class="label label-success available_qty" > 0 </span></div><span class="ajax_response_result"></span><input="hidden" class="quantity-err"></div></td><td scope="col" data-th="Price"><div class=""><input class="form-control price price_'+i+'" id="validationCustomUsername" name="price[]" type="text" placeholder="" aria-describedby="inputGroupPrepend"  required></div></td><td scope="col" data-th="CGST"><div class=""><input class="form-control cgst cgst_cls_'+i+'" id="validationCustomUsername" name="cgst[]" type="text" placeholder="" aria-describedby="inputGroupPrepend"  required></div></td><td scope="col" data-th="SGST"><div class=""><input class="form-control sgst sgst_cls_'+i+'" id="validationCustomUsername" name="sgst[]" type="text" placeholder="" aria-describedby="inputGroupPrepend" required ></div></td><td scope="col" data-th="IGST"><div class=""><input class="form-control igst igst_cls_'+i+'" id="validationCustomUsername" name="igst[]" type="text" placeholder="" aria-describedby="inputGroupPrepend"  ><div class="invalid-feedback">Field is required.</div></div></td><td scope="col" data-th="Net Value"><div class=""><input class="form-control net_value net_value_cls_'+i+'" id="validationCustomUsername" name="net_value[]" type="text" placeholder="" aria-describedby="inputGroupPrepend"  required></div></td><td data-th="Remove "><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove btn-sm"><i class="icofont icofont-minus"></i></button></td></tr>');
    ...
    function selectProduct(dataID,iProductId,val,type,category_id,color_id) {
        ...
        var stateid = $(".headoffice").find('option:selected').attr('data-state');
        // if(stateid==2)
        // {
