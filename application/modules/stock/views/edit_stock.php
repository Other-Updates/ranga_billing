                                    ...
                                    <table class="table delivery-order basictable" id="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="4%" scope="col" class="text-center"><b class="wnone">Remove</b> <button type="button" class="btn btn-t-success btn-sm" id="add"><i class="icofont icofont-plus"></i></button></th>
                                            </tr>
                                        </thead>
