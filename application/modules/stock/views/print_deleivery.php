...
<style>
    ...
    .footer-sign td.text-start{text-align:left;}
@media print {    
    ...
    <tbody>
        ...
        <?php if($language == "english"){ ?>
            ...
            <tr>
                ...
                <td width="20%" style="text-align: right;font-weight: bold;">Delievery Branch : </td>

                <td width="30%"><?php echo $deleivery_order[0]['vBranchName']; ?></td>

                <td width="20%" style="text-align: right;font-weight: bold;">Delievery No :</td>

                <td width="30%"><?php echo $deleivery_order[0]['vDeliveryOrderNo']; ?></td>
            ...
            <tr>
                ...
                <td><?php echo $deleivery_order[0]['vAddress'] ?></td> -->

                <td style="text-align: right;font-weight: bold;">Delievery Date :</td>

                <td><?php echo date("d-m-Y",strtotime($deleivery_order[0]['dDeliveryDate'])); ?></td>

                <td style="text-align: right;font-weight: bold;">Aadhaar / GST No :</td>
                <td ><?php echo $deleivery_order[0]['vAdhaarGst']; ?></td>
            ...
            <td  style="text-align: right;font-weight: bold;">Shipped To :</td>
                ...
                <td ><?php echo (!empty($deleivery_order[0]['vShippingAddress']))?$deleivery_order[0]['vShippingAddress']:$deleivery_order[0]['vAddress']; ?></td>
            ...
            <tr>
                ...
                <td><?php echo $deleivery_order[0]['vStateName']; ?></td>

                <td  style="text-align: right;font-weight: bold;">Mobile No :</td>

                <td width="20%"><?php echo $deleivery_order[0]['vMobileNumber']; ?></td>
                
                <td class="d-none state_id" style="display:none;"><?php echo $deleivery_order[0]['iStateId'] ?></td>
        ...
        <?php }if($language == "tamil"){ ?>
            ...
            <tr>
                ...
                <td width="25%" style="text-align: right;font-weight: bold;">வாடிக்கையாளர் : </td>

                <td width="25%"><?php echo $deleivery_order[0]['vBranchName']; ?></td>

                <td style="text-align: right;font-weight: bold;">அனுப்பப்பட்ட முகவரி  : </td>
                <td width="20%"><?php echo (!empty($deleivery_order[0]['vShippingAddress']))?$deleivery_order[0]['vShippingAddress']:$deleivery_order[0]['vAddress']; ?></td>
            ...
            <tr>
                ...
                <td width="20%"><?php echo $deleivery_order[0]['vDeliveryOrderNo']; ?></td>
            ...
            <tr>
                ...
                <td><?php echo $deleivery_order[0]['vPhoneNumber'] ?></td> -->
            ...
            <?php } if(!empty($deleivery_order[0]['gst_no'])){ ?>

            <tr>

                <td style="text-align: right;font-weight: bold;">GSTIN : </td>

                <td><?php echo $deleivery_order[0]['gst_no']; ?></td>
...
<table class="product-list" id="product-list" cellpadding ="0" cellspacing="0">
    ...
    <thead>
        ...
        <?php if($language == "english"){ ?>
            ...
            <tr>
                ...
                <?php if($deleivery_order[0]['CGST']!=0 || $deleivery_order[0]['CGST']!=0){ ?>
                <th width="10%">GST% </th>
               <?php } else {?>
                <th width="10%">IGST%</th>
                <?php } ?>
        ...
        <?php if($language == "tamil"){ ?>
            ...
            <tr>
                ...
                <?php if($deleivery_order[0]['iStateId']==2){ ?>
                <th width="10%">GST%</th>
               <?php } else {?>
                <th width="10%">IGST%</th>
                <?php } ?>
    ...
    <tbody>
        ...
        <?php $i=1; foreach($deleivery_order[0]['deleivery_details'] as $key=>$order){ ?>
    ...
    <table class="total product-list" cellpadding ="0" cellspacing="0">
        ...
        <tbody>
            ...
            <?php $j=1; foreach ($deleivery_order[0]['deleivery_details'] as $key => $order_) { ?>
