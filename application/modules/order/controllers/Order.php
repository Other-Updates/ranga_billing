    ...
    public function get_sales_order(){
        ...
        foreach ($list as $key=>$post) {
            ...
            if($post->eDeliveryStatus == "Delivered"){
                $edit = "";
                $delete = "";
                $return = '<a href="'.base_url('order/sale_order_return/').$post->iSalesOrderId.'" data-id="'.$post->iSalesOrderId.'" class="action-icon" ><button style="font-size: 11px;padding: 0px 8px;" class="btn btn-return">Return</button></a></a>';
