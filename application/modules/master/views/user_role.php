                            ...
                            <?php foreach($user_roles as $roles){ ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="" data-id= "<?php echo $roles['iUserRoleId'] ?>" class="action-icon addAttr" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_user"><i class="icofont icofont-ui-edit"></i></a>
                                        <a href="" data-id= "<?php echo $roles['iUserRoleId'] ?>" class="action-icon removeAttr " ><i class="icofont icofont-ui-delete"></i></a>
                                    </td>
                                </tr>
                            <?php $sno++;
                            } ?>
