        ...
        <form method="post">
            ...
            <table class="table custom-table mnone">
                <tr>
                    ...
                    <td width="35%" class="bold"><?php echo $receipt_details[0]['vSalesOrderNo'] ?></td>
...
<!--                    <td><span  class="tdhead">Return Amount:</span></td>
                ...
                <tr>
                    ...
                    <!-- <td colspan="2"></td> -->
                   <td><span  class="tdhead">Expense Amount:</span></td>
                   <td><?php echo number_format($receipt_details[0]['expense'], 2, '.', ',') ?></td>
                </tr>
            </table>
            <div class="row g-3 wnone">
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control" type="text" value="<?php echo $receipt_details[0]['vSalesOrderNo'] ?>" readonly="">
                </div>
                <div class="col-md-4">
...
<div class="card"> 
  ...
  <div class="section-title b-0 p-0">Payment History</div>
        <table class="table table custom-table basictable list-table">
            <thead>
            ...
            <th class="action-btn-align text-center">Expense&nbsp;Amt</th>
            ...
            <tbody id='receipt_info'>
                ...
                if (isset($receipt_details[0]['receipt_history']) && !empty($receipt_details[0]['receipt_history'])) {
                    ...
                    foreach ($receipt_details[0]['receipt_history'] as $val) {
                        ...
                        <tr>
                            ...
                            <td class="text_right"><?php echo number_format($val['expense'], 2, '.', ',') ?></td>
                ...
                <td></td>
                <td></td>
                <td class="text_right total-bg"> <span class="iwnone">Received Amount : </span> <?php echo number_format($paid, 2, '.', ',') ?></td>
                <?php if ($receipt_details[0]['inv_id'] != 'Wings Invoice') { ?>
                    <td class="text_right total-bg"><span class="iwnone">Discount ( % ) : </span> <?php echo number_format($dis, 2, '.', ',') ?></td>
                    <td></td><td></td>
        ...
        <a href="<?php echo $this->config->item('base_url') ?>sales_receipt/receipt_list" class="btn btn-danger"><span class="glyphicon"></span> Back </a>
            <br>
            <br>
        </div>
    </div>
