...
<table style="padding: 2px 2px;" row-style="page-break-inside:avoid;">
    <tr style="background-color:#e6e6ff;"><th  colspan="2"><strong>Sales Invoice Details</strong></th></tr>
    <tr>
        <td align="left" ><b>Name:</b>
            <b><?php echo ucfirst($receipt_details[0]['vCustomerName']); ?></b><br/><br/>
...
<!--        <td width ="11%"><b>CGST&nbsp;%</b></td>
    ...
    <tfoot>
        ...
        <tr>
            <td colspan="4" align="right"><strong>Expense Amount</strong></td>
            <td align="right"><?php echo number_format($receipt_details[0]['receipt_history'][0]['expense'], 2, '.', ',') ?></td>
        </tr>
        <tr>
            <td colspan="4" align="right"><strong>Additional Charge</strong></td>
            <td align="right"><?php echo number_format($receipt_details[0]['fAdditionalCharge'], 2, '.', ',') ?></td>
        </tr>
            <tr>
