    ...
    <div class="page-title">
        <div class="row">
            ...
            <div class="col-6">
                ...
                <li class="breadcrumb-item active">Update Payment Receipt</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="card"> 
  <div class="card-body">
    <div class="section-title b-0 p-0">Payment History</div>
        <table class="table custom-table basictable view-table">
            <thead>
            <th width="1%">S&nbsp;No</th>
            ...
            <th class="text-center">Expense&nbsp;Amt</th>
            ...
            <tbody id='receipt_info'>
                ...
                if (isset($receipt_details[0]['receipt_history']) && !empty($receipt_details[0]['receipt_history'])) {
                    ...
                    foreach ($receipt_details[0]['receipt_history'] as $val) {
                        ...
                        $exp_amt = $exp_amt + $val['expense'];
                        $dis = $dis + $val['discount'];
                        ?>
                        <tr>
                            <td class="text-center"><?php echo $i ?></td>
                            <th class="rec_no<?php echo $val['id'] ?> text-center"><?php echo $val['receipt_no'] ?></th>
                            <!--<th><?php echo $val['recevier'] ?></th>-->
                            <td class="rec_c_date<?php echo $val['id'] ?> text-center"><?php echo date('d-M-Y', strtotime($val['created_date'])) ?>
                            <input type='hidden'  class="datepicker-here rec_d_date<?php echo $val['id'] ?>" name='due_date'  value="<?php echo date('d-M-Y', strtotime($val['due_date'])) ?>" />
                    ...
                    <input type="hidden" class="rec_expense<?php echo $val['id'] ?>" name="expense" value="<?php echo $val['expense'] ?>">
                    ...
                    <td class="text-right rec_expense_1<?php echo $val['id'] ?>"><?php echo number_format($val['expense'], 2, '.', ',') ?></td>
                    <td class="text-right rec_bill<?php echo $val['id'] ?>"><?php echo number_format($val['bill_amount'], 2, '.', ',') ?></td>
                    ...
                    <?php if ($receipt_details[0]['inv_id'] != 'Wings Invoice') { ?>
                        <td class="hide_class text-center">
                            <button type="button" rec_id ="<?php echo $val['id'] ?>" class="action-btn edit payedit action-icon" data-id="<?php echo $val['id']; ?>" id="edit_model" data-toggle="modal" data-target="#Model" title="" data-original-title="Edit"><span class="icofont icofont-ui-edit"></span></button>
                            ...
                            <button type="button" rec_id ="<?php echo $val['id'] ?>"class="action-btn print6 print action-icon"><span class="icofont icofont-printer"></span></button>
                        </td>
                    <?php } ?>
                    </tr>
                    <?php
...
<div class="card"> 
  <div class="card-body">
        ...
        ?>
        <form method="post">
        <input type="hidden" name="receipt_bill[created_at]" value="<?php echo $receipt_details[0]['iSalesmanId'] ?>">
            <input type="hidden" name="receipt_bill[receipt_id]" value="<?php echo $receipt_details[0]['iSalesOrderId'] ?>">
            <div class="section-title b-0 p-0">Sales Invoice Details</div>
            <table class="table custom-table sales-recipt-update">
                <thead>
                <th width="5%" class="text-center">S No</th>
                <th width="15%" class="text-center">Invoice NO</th>
                <th width="60%" class="text-center">Invoice Date</th>
                <th width="20%" class="text-right">Amount</th>
                </thead>
                <tbody id='receipt_info'>
                    <tr>
                        <td class="text-center">1</td>
                        <td class="text-center"><?php echo $receipt_details[0]['vSalesOrderNo'] ?></td>
                        <td class="text-center"><?php echo date('d-M-Y', strtotime($receipt_details[0]['dCreatedDate'])) ?></td>
                        <td class="text-right"><?php echo number_format($receipt_details[0]['fNetCost'], 2, '.', ',') ?></td>
                    </tr>
                ...
                <tr>
                    <td colspan="3" style="text-align:right;">Receipt NO</td><td><input class="form-control text-center" name="receipt_bill[receipt_no]" type="text" value="<?php echo $last_id[0]['code']; ?>"></td>
                </tr>
                <tr>
                    <td colspan='3' style='text-align: right;'>Payment Terms</td><td >
                        <select class='form-control' id='terms1' style="float:right; display:none;" name='receipt_bill[terms]' tabindex="1" id="recp_no">
                            <option class="1" value='1'>CASH</option>
                        </select>
                        <select class='form-control' id='terms' style="" name='receipt_bill[terms]' tabindex="1">
                            <option class="1" value='1'>CASH</option>
                ...
                <tr class='show_tr' style='display:none'>
                    ...
                    <td >
                        <input id='ac_no'  class='form-control'  style=' float:left;' type='text'  name='receipt_bill[ac_no]' tabindex="1"/><div class="clearfix"></div>
                ...
                <tr class='show_tr' style='display:none'>
                    ...
                    <td>
                        <input id='branch'  class='form-control'  style=' float:left;' type='text'  name='receipt_bill[branch]' tabindex="1"/><div class="clearfix"></div>
                ...
                <tr  class='show_tr' style='display:none'>
                    ...
                    <td >
                        <input id='dd_no'  class='form-control' style=' float:left;' type='text'  name='receipt_bill[dd_no]' tabindex="1"/><div class="clearfix"></div>
                        <span id="receiptuperror2" style="color:#F00;" ></span><div class="clearfix"></div><span id="dupperror" style="color:#F00;" ></span></td>
                </tr>
                <tr>
                    <td colspan="3" style="text-align:right;"><span style='  position: relative; top: 5px;'>Discount &nbsp;(&nbsp;%&nbsp;)&nbsp; </span>
                        <input id='discount_per' autocomplete='off'  class='form-control text-center' style='width:100px;  float:right;' type='text'  name='receipt_bill[discount_per]' tabindex="1"/>
                    </td>
                    <td>
                        <input id='discount'  class='form-control dot_val text-right' type='text'  name='receipt_bill[discount]' tabindex="1"/>
                    </td>
                </tr>
                <tr>
                    <td colspan="3" style="text-align:right;">Paid Amount</td>
                    <td>
                        <input id='paid'  class='form-control dot_value text-right' type='text'  style=' float:right;'  name='receipt_bill[bill_amount]'  tabindex="1"/><div class="clearfix"></div>
                        <span id="receiptuperror3" style="color:#F00;" ></span> </td>
                </tr>
                <tr>
                    <td colspan="3" style="text-align:right;">Due Date</td>
                    <td>
                        <input type='text'   class="<?php echo $class; ?> form-control text-right" name='receipt_bill[due_date]'  value="<?php echo $due_date ?>" <?php echo $disabled; ?> tabindex="1"/>
                    </td>
                </tr>
                <tr>
                    <td colspan="3" style="text-align:right;">Created Date</td>
                    <td>
                        <input type='text'  id='c_date' class="form-control text-right datepicker-here" value="<?php echo date("d/m/Y") ?>" name='receipt_bill[created_date]' >
                        <span id="date_err" style="color:#F00;" ></span>
                    </td>
                </tr>
                <!-- <tr>
                    <td colspan="3" style="text-align:right;">Expense Charge</td>
                    <td>
                        <input type='text'  id='expense_chrg' class="form-control text-right expense_chrg dot_value" value="<?php echo ($receipt_details[0]['expense']!='')?$receipt_details[0]['expense']:'0.00'; ?>" name='receipt_bill[expense]' >
                        <span id="date_err" style="color:#F00;" ></span>
                    </td>
                </tr> -->
                <tr>
                    ...
                    <td>
                        <input id='balance'  class='form-control text-right' type='text'   name='balance'   value='<?php echo number_format((($receipt_details[0]['payable_amt'] - $dis) - $paid), 2, '.', ','); ?>'  readonly='readonly' tabindex="1"/>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <span style="position: relative;">Expense Charge</span>
                        <input type='text'  id='expense_chrg' class="form-control text-right expense_chrg dot_value" value="<?php echo ($receipt_details[0]['expense']!='')?$receipt_details[0]['expense']:'0.00'; ?>" name='receipt_bill[expense]' >
                        <span id="date_err" style="color:#F00;" ></span>
                    </td>
                    <td colspan="" style="text-align:right;">Remarks</td>
                    <td>
                        <input type='text'  class="form-control" name='receipt_bill[remarks]'  tabindex="1"/>
                    </td>
                </tr>
                <tr><td class="action-btn-align"  colspan="4"> 
                        <input  type="submit" class="btn btn-success" value="Pay" id="pay" tabindex="1"/>
                        <a class="btn btn-danger back pull-left" href="<?php echo $this->config->item('base_url') ?>sales_receipt/receipt_list"> Back </a>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 show_div" style='display:none'>
                                <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <input type='text' id="d_date"  class="form-control datepicker-here" name='due_date'  value=""  tabindex="1"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <input type='text'  id='cr_date'  class="datepicker-here form-control" name='created_date' value="" tabindex="1"/><div class="clearfix"></div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <span class="col-md-12">Expense Amount</span>
                                    <div class="form-group col-md-12">
                                        <input id='expense_amt1'  class='form-control dot_value' type='text'  style=' width:100% ;float:left;' value=""  name='expense'  tabindex="1"/><div class="clearfix"></div>
                                        <span id="receiptuperror33" style="color:#F00;" ></span>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $('.print').click(function () {
        r_id = '<?php echo $receipt_details[0]['receipt_history'][0]['receipt_id'] ?>';
    ...
    $('#discount').live('keyup', function () {
        ...
        var balance = "<?php echo ((($receipt_details[0]['payable_amt'] - $dis) - $paid)); ?>";
...
<script>
    ...
    $(document).on("click",".payedit",function(e){
        ...
        var rec_expense = $(".rec_expense" + id).val();
        ...
        $('#form_id').attr('action',"<?php echo $this->config->item('base_url') ?>sales_receipt/update_receipt_payment/" + id);
