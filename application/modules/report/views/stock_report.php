...
<script>
    ...
    function datatable(branch="",category="",subcategory=""){
        var table = $('#basic').DataTable({
            ...
            "order":[], 
            "ajax": {
                url : "<?php echo base_url('report/stock_report/get_branch_stock'); ?>",
            ...
            "createdRow": function(row, data, dataIndex) {
                ...
                $(row).find('td:eq(3)').attr('data-th', 'Category');
                $(row).find('td:eq(4)').attr('data-th', 'Subcategory');
                $(row).find('td:eq(5)').attr('data-th', 'Product');
                $(row).find('td:eq(6)').attr('data-th', 'Unit');
                $(row).find('td:eq(7)').attr('data-th', 'Quantity');
                $(row).find('td:eq(8)').attr('data-th', 'Price');
                $(row).find('td:eq(8)').attr('class', 'text-right');
            },
            "columnDefs":[{"targets":[0],"orderable":false,}, {"targets":[0, 8],"className":"text-center"} ], 
            "dom": 'lBfrtip',
            "buttons": [
                'excel', 'csv', 'pdf', 'copy',
            ],
